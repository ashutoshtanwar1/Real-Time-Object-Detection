...
def object_detect(image,conf=0.5,threshold=0.3):
...
class VideoCamera(object):
    ...
    def get_frame(self):
        _, cv2_im = self.cap.read()
        img,text,x,y = object_detect(cv2_im) 
        # cv2.putText(img, "HEY", (x+100, y+150), cv2.FONT_HERSHEY_SIMPLEX,3, (0,0,0), 2)
